...
##
LIB_SEL = pwrmgmt sensordp tflmtag2405_u55tag2405 spi_ptl spi_eeprom hxevent img_proc
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/tflm_fd_1mb.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/tflm_fd_1mb.ld
endif
